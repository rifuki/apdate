        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-3 mb-2">
              <a href="<?= base_url('guru/wali-kelas/pertemuan/modul/'.$slug) ?>" class="text-white" style="text-decoration:none;">
            ...
            <div class="col-md-3 mb-2">
              <a href="<?= base_url('guru/wali-kelas/pertemuan/pranala-luar/'.$slug) ?>" class="text-white" style="text-decoration:none;">
            ...
            <div class="col-md-3 mb-2">
              <a href="<?= base_url('guru/wali-kelas/pertemuan/diskusi/'.$slug) ?>" class="text-white" style="text-decoration:none;">
            ...
            <div class="col-md-3 mb-2">
              <a href="<?= base_url('guru/wali-kelas/pertemuan/absensi/'.$slug) ?>" class="text-white" style="text-decoration:none;">
