        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-3 mb-2">
              <a class="menu-pertemuan" data-status="<?= $status ?>" href="<?= base_url('siswa/pertemuan/modul/'.$slug) ?>" class="text-white" style="text-decoration:none;">
            ...
            <div class="col-md-3 mb-2">
              <a class="menu-pertemuan" data-status="<?= $status ?>" href="<?= base_url('siswa/pertemuan/pranala-luar/'.$slug) ?>" class="text-white" style="text-decoration:none;">
            ...
            <div class="col-md-3 mb-2">
              <a class="menu-pertemuan" data-status="<?= $status ?>" href="<?= base_url('siswa/pertemuan/diskusi/'.$slug) ?>" class="text-white" style="text-decoration:none;">
            ...
            <div class="col-md-3 mb-2">
              <a class="menu-pertemuan" data-status="<?= $status ?>" href="<?= base_url('siswa/pertemuan/tugas/'.$slug) ?>" class="text-white" style="text-decoration:none;">
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.menu-pertemuan').forEach(function(link) {
      link.addEventListener('click', function(e) {
        var status = this.getAttribute('data-status');
        if(status === 'belum') {
          toastError('Pertemuan belum dibuka oleh guru pengajar');
          e.preventDefault();
        }
      });
    });
